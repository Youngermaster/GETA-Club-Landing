export default {
  ...
  colors: {
    ...
    yellow: "#37403D", // border color
    primary: "#F20FA3", // primary button and link color
    secondary: "#05C7F2", // secondary color - can be used for hover states
    muted: "#F2F2F2", // muted color
